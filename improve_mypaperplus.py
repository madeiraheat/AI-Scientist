...
from ai_scientist.perform_reviewplus import perform_review, load_paper, perform_improvement
...
if writeup == "latex" and improvement:
    ...
    try:
        perform_improvement(review, coder, paper_text)
    except Exception as e:
        print(f"Failed to perform improvement {e}")
       
        print("Done improvement")
